            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('books.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="pdf_file" class="col-md-4 col-form-label text-md-end text-start">PDF File</label>
                            <div class="col-md-6">
                        ...
                        <input type="hidden" class="form-control" id="user_name" value="{{ $user->name }}" readonly>
